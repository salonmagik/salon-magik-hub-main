...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "scrollbar-hide inline-flex h-10 max-w-full items-center justify-start overflow-x-auto overflow-y-hidden overscroll-x-contain rounded-md bg-muted p-1 text-muted-foreground",
      className,
    )}
    {...props}
  />
