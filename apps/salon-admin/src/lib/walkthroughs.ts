...
export const WALKTHROUGHS: WalkthroughDef[] = [
  ...
  // orientation even before they have anyone to message.
  {
    ...
    description: "Broadcasts, templates, and delivery history",
    ...
    buildStep: () => ({
      ...
      title: "Marketing",
      content: "Choose your audience, write an email or SMS, preview your message, and send. Manage automated templates and check delivery history here too.",
    }),
  },
  {
    id: "messaging.single",
