-- Migration: Fix debit_salon_purse reference_id parameter type to UUID
-- Description: Updates the function signature to accept UUID instead of TEXT for p_reference_id
--              to match the wallet_ledger_entries.reference_id column type
-- Created: 2026-04-08
