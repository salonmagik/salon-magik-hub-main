-- Canonical staff members resolver for salon-admin staff screens.
-- Includes auth email + joined timestamp fallback chain.
...
begin
  ...
  select
    ...
    sr.is_active,
    sr.role_assigned_at,
    coalesce(sr.auth_email, lower(ibu.email)) as email,
