-- Add booking_page_bio to tenants for ecommerce storefront header display.
alter table public.tenants
  add column if not exists booking_page_bio text;

comment on column public.tenants.booking_page_bio is 'Short description displayed on the public storefront header (ecommerce theme).';
