-- Migration: Update credit_salon_purse reference_id to UUID
-- Description: Align credit_salon_purse reference_id with wallet_ledger_entries.reference_id type
-- Created: 2026-04-03

-- Drop old signature to avoid overload ambiguity
DROP FUNCTION IF EXISTS credit_salon_purse(UUID, wallet_entry_type, TEXT, TEXT, NUMERIC, TEXT, TEXT, TEXT);
